...
When you initialize the chart using its constructor Highcharts.Chart), the options object is the second parameter you pass:
...
Note: The themes supplied with Highcharts download use this function. See Themes for more information.

For a full reference of the options available, see the Highcharts options reference or the Highcharts Stock options reference.
