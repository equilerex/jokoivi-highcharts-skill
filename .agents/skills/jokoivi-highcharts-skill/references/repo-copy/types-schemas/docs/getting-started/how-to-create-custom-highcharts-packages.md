...
Go to the `highcharts/highcharts`
...
Node.js website. Highcharts supports the LTS variant.
...
According to our [installation](./getting-started/installation.md) guide you can reference your
