...
without any bundling tools by using `<script type="module">` (demo):
```html
<script type="module">
...
docs, or view it
live on jsFiddle in our ESM autload demo.
...
*The following examples assume you have used npm to install Highcharts; see installation with npm for more details.*
