...
The code of `bubbleLegend` is very simple to set, and it allows a lot of customization. The part of the options like minSize, maxSize, sizeBy, and the size calculation method works in the same way as in a bubble series.
