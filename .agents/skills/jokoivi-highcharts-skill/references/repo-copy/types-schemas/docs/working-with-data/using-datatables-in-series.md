...
The `dataTable` and `dataMapping` options provide a structured approach to
...
```
See an example of adding and shifting data rows.
...
- Chart-level dataTable
- Series-level dataTable
- series.dataMapping
- DataTable class reference

## See also

- [Working with data](./working-with-data/data-intro)
- [Data module](./working-with-data/data-module)
- [Chart series](./chart-concepts/series)
