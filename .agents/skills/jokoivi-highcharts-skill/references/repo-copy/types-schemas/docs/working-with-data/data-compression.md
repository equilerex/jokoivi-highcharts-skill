...
The `data` option of a series supports [three basic ways](./chart-concepts/series#the-data-in-a-series) of providing data. However, Highcharts requires `x` values on a datetime axis to be given in JavaScript timestamps, which are milliseconds since 1970-01-01.
