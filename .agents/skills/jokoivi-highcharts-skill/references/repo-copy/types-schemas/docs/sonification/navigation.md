...
<iframe style="width: 100%; height: 635px; border: none;" src="" allow="fullscreen"></iframe>
...
The above demo illustrates some of these capabilities, which is easily set up using built-in functions such as chart.sonification.playAdjacent and chart.sonification.playAdjacentSeries.
...
Highcharts has a builtin chart.sonification.playSegment function that helps facilitate scrubbing interaction.

The below demo illustrates how this can be used.

<iframe style="width: 100%; height: 565px; border: none;" src="" allow="fullscreen"></iframe>
