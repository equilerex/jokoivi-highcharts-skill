...
<iframe style="width: 100%; height: 822px; border: none;" src="" allow="fullscreen"></iframe>
...
For a complete overview of the mapping properties available, with all the detailed configuration options for each, see defaultInstrumentOptions.mapping for instrument tracks, and defaultSpeechOptions.mapping for speech tracks.
...
Next Steps:
-----------
This article dealt with the basics of mapping configuration. The next step up is exploring [more advanced mapping](./sonification/advanced-mapping) options.
