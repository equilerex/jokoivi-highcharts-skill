...
Here is the standalone demo.
Here is the tailwind demo.

*Please note that that [Edit Mode](./dashboards/edit-mode) can not be used when
...
For information on how to individually style the dashboard's `Highcharts chart` see the article [style Highcharts Chart.](./chart-design-and-style/style-by-css)
...
For detailed guidance on styling the Grid component, refer to the [Introduction to Theming](./grid/theming/index) article.
