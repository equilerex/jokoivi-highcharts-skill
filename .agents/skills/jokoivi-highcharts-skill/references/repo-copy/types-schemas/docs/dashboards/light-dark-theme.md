...
2. Alternatively, use styledMode and import ``. Enable the `styledMode` option for all components that contain a chart. You can do this by setting the `styledMode` option to `true` in the component's configuration.
...
<iframe style="width: 100%; height: 1264px; border: none;" src="" allow="fullscreen"></iframe>
