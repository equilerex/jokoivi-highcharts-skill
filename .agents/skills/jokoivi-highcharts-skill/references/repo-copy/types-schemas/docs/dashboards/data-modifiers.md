...
- `getLocalRowIndex` - Takes the original row index as an argument and returns the local row index in the modified table for which this function is called.
- `getOriginalRowIndex` - Takes the local row index (in the modified table for which it is called) as an argument and returns the index of the corresponding row in the original table.
...
<iframe style="width: 100%; height: 733px; border: none;" src="" allow="fullscreen"></iframe>
