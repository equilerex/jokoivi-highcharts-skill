...
Instead of regular CSS media queries, you can also use container queries, which will make more sense if your dashboard does not cover the entire window horizontally. See a demo that uses this.
...
*NB! Disabled `gui` does not allow you to use the [Edit Mode](./dashboards/edit-mode) module.
