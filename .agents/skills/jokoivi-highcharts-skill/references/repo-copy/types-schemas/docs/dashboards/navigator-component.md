...
navigator of [Highcharts Stock](./stock/navigator) to provide an overview of the values of a table
...
The Navigator component can be synced with other components in **Dashboards**. Two synchronization types are predefined for the Navigator component: `crossfilter` and `extremes`. You can find more information about it in the [sync article](./dashboards/synchronize-components).
...
other crossfilters. See the demo here.

Read more about components synchronization [here](./dashboards/synchronize-components).

### Crossfilter Example

<iframe style="width: 100%; height: 600px; border: none;" src="" allow="fullscreen"></iframe>

In the crossfilter demo
