...
the attr
function, or by animation through the animate function. Check out this demo for some
...
other options, like for example chart.className, be used to identify individual charts. Read more about
addEvent
and see the addEvent and render demo.
...
Note that we haven't supplied the actual path definition yet, and we have not
