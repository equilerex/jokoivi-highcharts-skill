...
We will focus on creating a more complex annotation, specifically Fibonacci retracement, a tool used in technical analysis which allows users to identify reversal levels. For a broader overview of our built-in advanced annotation tools, see the [advanced annotations](./stock/advanced-annotations).
