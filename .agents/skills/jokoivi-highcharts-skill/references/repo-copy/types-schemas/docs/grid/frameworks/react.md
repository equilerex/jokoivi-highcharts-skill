...
See the live Grid Lite example.
See the live Grid Pro example.
...
## 5. Next.js
For Next.js applications, see the dedicated [Next.js integration guide](./grid/frameworks/nextjs).
