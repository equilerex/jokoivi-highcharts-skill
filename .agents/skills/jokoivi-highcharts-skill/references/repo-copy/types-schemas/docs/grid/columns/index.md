...
See [Column headers](./grid/columns/header).
...
[Column grouping](./grid/columns/grouping).
...
[Column width and resizing](./grid/columns/resizing-and-width).
...
[Column sorting](./grid/columns/sorting).
...
[Cell formatting](./grid/cells/formatting).
