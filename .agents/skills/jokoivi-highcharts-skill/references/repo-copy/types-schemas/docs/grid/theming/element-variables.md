...
For table surfaces such as rows, columns, headers, and cells, see [Grid variables](./grid/theming/grid-variables).
...
4. Combine with [Grid variables](./grid/theming/grid-variables) for full table and element theming.
