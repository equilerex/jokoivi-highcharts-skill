...
All general header configuration described in the [article on column headers](./grid/columns/header), including formatting, classes, accessibility options, and precedence rules, also applies when using grouped columns.
