...
[Column filtering](./grid/columns/filtering),
including the [upgrading](./grid/columns/filtering#upgrading-column-filtering)
...
Number formatting in templates is handled by the [template engine](./chart-concepts/templating). The following example formats numbers with thousands separators:
