...
server request instead. Read more in [Server-side data handling](./grid/data-handling/serverside).
...
See [Interaction / Events](./grid/events) for event details.

## API reference

- `columnDefaults.sorting`
- `columns.sorting`
