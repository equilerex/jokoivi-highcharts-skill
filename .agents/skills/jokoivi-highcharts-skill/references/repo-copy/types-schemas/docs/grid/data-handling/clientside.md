...
[`data.connector`](./grid/data-handling/connectors),
...
DataTable](./dashboards/data-table).
...
This means a [connector-backed Grid](./grid/data-handling/connectors)
...
[connector](./grid/data-handling/connectors)
...
sent to the browser, use [Server-side data handling](./grid/data-handling/serverside) instead.
