...
when templating is not enough. Grid uses the same [templating engine as Core](./chart-concepts/templating).
...
See [Templating](./chart-concepts/templating)
...
[Editing / Renderers](./grid/editing/renderers).
