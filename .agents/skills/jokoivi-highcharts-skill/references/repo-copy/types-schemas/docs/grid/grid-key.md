...
Purchase or manage Grid Pro licensing through the Highsoft shop. The Grid Key is located in the provided License Statement. A new Grid Key is issued on each renewal, and the key in your application must be updated.

Customers who purchased a Grid Pro or Dashboards license before **May 6, 2026** can find their Grid Key in the updated License Statement at 
