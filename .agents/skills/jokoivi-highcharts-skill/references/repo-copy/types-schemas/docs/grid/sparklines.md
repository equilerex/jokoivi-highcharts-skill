...
Check out the sparklines demo for how to implement sparklines with different configuration options and read more below.
...
## Configuration
You can configure the sparkline using the `chartOptions` API option, that supports all Highcharts Core API options.
