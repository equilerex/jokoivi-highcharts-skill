...
state should be handled by the server instead. Read more in [Server-side data handling](./grid/data-handling/serverside).
...
[Internationalization](./grid/internationalization)).
