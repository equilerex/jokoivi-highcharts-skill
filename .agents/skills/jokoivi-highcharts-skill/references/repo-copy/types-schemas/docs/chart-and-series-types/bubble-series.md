...
A bubble series renders bubbles, which radius are proportional to a `z` value, on given `x` and `y` positions. It is an extended form of a [scatter series](./chart-and-series-types/scatter-chart).
...
Bubble Legend
-------------
Bubble series supports a special type of representation in the legend through the [bubble legend](./chart-concepts/bubble-legend) module.
