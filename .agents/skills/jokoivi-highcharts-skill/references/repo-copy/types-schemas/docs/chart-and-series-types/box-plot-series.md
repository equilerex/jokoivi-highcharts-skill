...
The different parts of the box anatomy can be styled individually. The stem, whiskers and median have their own options for line width, color and dash style, while the box itself is subject to the color, lineWidth and fillColor options. See plotOptions.boxplot for a full reference, and the box plot styling sample for a demonstration.
