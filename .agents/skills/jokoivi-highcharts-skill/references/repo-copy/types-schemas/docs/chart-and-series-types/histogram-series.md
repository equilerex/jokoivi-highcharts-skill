...
A histogram series is a graphical representation of the data distribution of an attribute. Histogram creates intervals (bins) and counts how many values fall into each bin. The module modules/histogram-bellcurve.js is required for this chart.
...
The histogram series is a column series with no padding between the columns and with self-setting data. The data property can be substituted by a base series (more precisely y values of the data).
...
<iframe width="100%" height="470" style="null" src="" allow="fullscreen"></iframe>
