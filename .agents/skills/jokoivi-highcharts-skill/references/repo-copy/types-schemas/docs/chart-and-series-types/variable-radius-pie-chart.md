...
The variable radius pie series type requires the following module modules/variablepie.js.
...
*   **minPointSize**: This option sets the minimum size of any points' radius with a value closes to zero. This option works similar to minPointLength in column charts.
