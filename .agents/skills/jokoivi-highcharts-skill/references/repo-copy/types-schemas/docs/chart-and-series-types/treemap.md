...
<iframe width="320" height="410" style="border: 0; width: 100%; height: 420px;" src="" allow="fullscreen"></iframe>

### Requirements

The treemap chart requires the file`modules/treemap.js`.
For use with colorAxis, the `modules/heatmap.js` must be included as well.

### Data structure

The data is structured as a [tree](./chart-concepts/dataviz-glossary#tree-data-structure), where each point represents a node. Each node can have its own children.
...
Read more about the breadcrumbs [here](./advanced-chart-features/breadcrumbs).
...
<iframe style="border: 0; width: 100%; height: 420px;" src="" allow="fullscreen"></iframe>
...
*   Treemap with colorAxis
*   Treemap displaying the global mortality rate and causes
*   Treemap using level specific options
