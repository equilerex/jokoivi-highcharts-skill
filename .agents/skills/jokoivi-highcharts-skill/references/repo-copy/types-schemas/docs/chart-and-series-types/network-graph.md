...
<iframe style="width: 100%; height: 515px; border: none;" src="" allow="fullscreen"></iframe>
...
Nodes are generated automatically from `series.data` connections. Nodes are instances of Highcharts.Point and are available from the `series.nodes` array.
