...
The X-range series requires the following module modules/xrange.js.

_For more detailed samples and documentation check the API._

<iframe style="width: 100%; height: 332px; border: none;" src="" allow="fullscreen"></iframe>
...
Each data point may have a `partialFill` option that sets how much of the task is fulfilled.
