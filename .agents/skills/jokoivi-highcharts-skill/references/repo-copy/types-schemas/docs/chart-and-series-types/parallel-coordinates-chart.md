...
<iframe style="width: 100%; border: none;" src="" allow="fullscreen"></iframe>
...
Parallel coordinates chart requires the following module modules/parallel-coordinates.js.
...
*   **yAxis.tooltipValueFormat**: Use this option to personalize the tooltip for point.y and available in tooltip.pointFormat as `{point.formattedValue}`.
