...
For an overview of the scatter chart options see the API reference.

3D scatter charts
-----------------

In 3D charts, the scatter points also have a Z dimension. This is handled by a separate series type, scatter3D.
