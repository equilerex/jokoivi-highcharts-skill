...
<iframe style="width: 100%; height: 485px; border: none;" src="" allow="fullscreen"></iframe>
...
In addition to auto-generated properties, custom properties such as `color` or `colorIndex` can be set by adding an array, nodes, to the series options and linking the nodes by id; the following jsfiddle demo illustrates this concept.
