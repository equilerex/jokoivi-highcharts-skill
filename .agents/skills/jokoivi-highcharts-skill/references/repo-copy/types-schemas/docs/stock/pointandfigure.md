...
<iframe style="width: 100%; height: 1050px; border: none;" src="" allow="fullscreen"></iframe>
...
For more information on the Point and Figure chart, see the API reference, and the official demo.
