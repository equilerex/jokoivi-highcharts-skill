...
This article shows how to create custom technical indicators, in this case, linear regression. To read more about technical indicators offered by Highcharts click [here](./stock/technical-indicator-series).
...
**Module**
The indicator is available as a indicators/trendline.js main module.
...
*   `pointValKey`* - default value for pointValKey
...
A live demo of the above multiline indicator can be found here.
...
A live demo of the example above can be found here.
...
<Tabs
  ...
  <p>
    A live demo of the example (vanilla JS) <a href="">here</a>.
  </p>
  ...
  <p>
    A live demo of the example (React) <a href="">here</a>.
  </p>
  ...
  <p>
    A live demo of the example (Next) <a href="">here</a>.
  </p>
