...
The default the CSS file for [styled mode](./chart-design-and-style/style-by-css) is available as /css/highcharts.css on the root of `code.highcharts.com`, or via [NPM](./chart-design-and-style/style-by-css#loading-from-node_modules).
...
`highcharts.scss`. Read the old docs on how to set up and modify that.
