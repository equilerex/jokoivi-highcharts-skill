...
When using [styled
mode](./chart-design-and-style/style-by-css),
themes can be applied by loading [additional CSS
files](./chart-design-and-style/custom-themes-in-styled-mode#featured-themes).
...
See the [branding
page](./chart-design-and-style/branding) for
