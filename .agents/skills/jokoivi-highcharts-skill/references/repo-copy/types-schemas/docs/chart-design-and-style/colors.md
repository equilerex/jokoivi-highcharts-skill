...
under the palette API and the
[branding docs
article](./chart-design-and-style/branding).
...
See here for more information about using [color indices in styled mode](./chart-design-and-style/style-by-css).
...
See the online example of a linear gradient chart background.
...
See the demo of radial gradients in a pie chart.
...
*   [Pattern fills tutorial](./chart-design-and-style/pattern-fills)
*   PatternOptions in the API for options details.
