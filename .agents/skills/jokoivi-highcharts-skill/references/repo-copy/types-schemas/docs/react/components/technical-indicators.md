...
**Note:** To learn more about the `StockChart` component, see the [Chart documentation](./react/components/chart#highcharts-stock).

### Props

Technical indicators are implemented as series and accept the same [props](./react/components/series-types#props).
