...
You can add [drilldown](./chart-concepts/drilldown) to your chart using the `Drilldown` component:
...
The `Drilldown` component accepts all drilldown API options as props.
