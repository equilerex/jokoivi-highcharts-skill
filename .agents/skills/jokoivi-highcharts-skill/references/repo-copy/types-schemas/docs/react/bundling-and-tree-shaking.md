...
If you use components for Highcharts modules (for example [Accessibility](./react/components/modules/accessibility) or
[Exporting](./react/components/modules/exporting)), directly import only the modules you need:
